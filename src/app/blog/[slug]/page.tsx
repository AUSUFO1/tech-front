  ...
  return (
    <main className="mx-auto w-full max-w-[980px] px-5 pb-16 pt-8 sm:px-8 lg:pt-10">
      ...
      <p className="text-[0.72rem] font-bold uppercase tracking-[0.14em] text-primary-green">
        <Link href={post.categorySlug ? getQuickLinkHref(post.categorySlug, 'blog') : getCategoryHrefFromLabel(post.categoryTitle, 'blog')} className="hover:opacity-90">
          {post.categoryTitle}
        </Link>
      </p>
      <h1 className="mt-3 font-serif text-[2.4rem] font-bold leading-[1.05] tracking-[-0.02em] text-primary-text sm:text-[3.2rem]">
        {post.title}
      </h1>
      ...
      <AppImage
        ...
        className="mt-8 w-full object-cover max-h-[520px]"
        width={1400}
        height={840}
        sizes="100vw"
        priority
      ...
      <section className="mt-12 border-t border-border pt-8">
        <h2 className="font-serif text-[1.6rem] font-bold tracking-[-0.02em] text-primary-text">Related Guides</h2>
